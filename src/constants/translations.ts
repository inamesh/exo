...
export const TRANSLATIONS: Translations = {
    en_US: {
        title:      'Stay Home!',
        subtitle:   '... go out only if really necessary',
        step1:      'A - Enter your name & address',
    ...
    el_GR: {
        ...
        step1: 'Α - Συμπληρώστε τα στοιχεία σας',
        step2: 'Β - Επιλέξτε λόγο',
        step3: 'Γ - Αποστολή SMS',
        firstName:  'Όνομα',
        lastName:   'Επώνυμο',
        address:    'Διεύθυνση', 
